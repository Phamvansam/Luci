package com.vti.specification.management;
...
public class ManagementSpecification {
	...
	public static Specification<Management> buildWhere(String search,ManagementFilterForm filterForm) {
		
		Specification<Management> where = null;
...
class CustomSpecification implements Specification<Management> {
	...
	public Predicate toPredicate(
		...
		if (field.equalsIgnoreCase("username")) {
			Join join = root.join("residents", JoinType.LEFT);
